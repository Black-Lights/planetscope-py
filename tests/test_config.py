...
class TestPlanetScopeConfig:
    ...
    def test_system_config_loading(self, monkeypatch):
        ...
        monkeypatch.setattr("pathlib.Path.home", lambda: Mock(__truediv__=lambda self, other: mock_path))
    ...
    def test_to_dict_method(self):
        ...
        expected_keys = [
            'base_url', 'item_types', 'asset_types', 'rate_limits',
            'timeouts', 'max_retries', 'max_roi_area_km2', 'default_crs'
        ]
    ...
    @pytest.mark.parametrize("env_var,config_key,test_value", [
    ...
    def test_environment_variable_mapping(self, env_var, config_key, test_value, monkeypatch):
