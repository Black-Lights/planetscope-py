...
class MockPlanetAPI:
    ...
    def mock_request(self, method: str, url: str, **kwargs) -> requests.Response:
        ...
        elif "/item-types" in parsed_url.path and parsed_url.path.endswith("/item-types"):
    ...
    def _handle_search_request(self, method: str, url: str, **kwargs) -> requests.Response:
        ...
        response_data = {
            ...
            "features": filtered_scenes
        }
        
        return self._create_json_response(200, response_data)
    
    def _handle_stats_request(self, method: str, url: str, **kwargs) -> requests.Response:
    ...
    def _handle_assets_request(self, method: str, url: str, **kwargs) -> requests.Response:
    ...
    def _handle_item_types_request(self, method: str, url: str, **kwargs) -> requests.Response:
