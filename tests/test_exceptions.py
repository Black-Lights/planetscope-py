        ...
        try:
            try:
                try:
                    ...
                    raise APIError("API connection failed", {"network_error": str(e)}) from e
            except APIError as e:
                raise AuthenticationError("Auth failed due to network", {"api_error": str(e)}) from e
...
class TestExceptionIntegration:
    ...
    @pytest.mark.parametrize("exception_class,message,details", [
